...
lm_train_data=ru_base/etc/ru_base_test.text
# lm_train_data=""
...
idngram2lm -vocab_type 0 -idngram ru_base/etc/ru_base.idngram -vocab \
     ru_base/etc/ru_base.vocab -arpa ru_base/etc/ru_base_test.lm

# бинаризация языковой модели
sphinx_lm_convert -i ru_base/etc/ru_base_test.lm -o ru_base/etc/ru_base_test.lm.DMP
